...
### Instructions
1. Clone this repository by either `git clone --recurse-submodules -j8 https://github.com/North-West-Wind/opensurviv-server.git` or downloading as ZIP and extracting it.
